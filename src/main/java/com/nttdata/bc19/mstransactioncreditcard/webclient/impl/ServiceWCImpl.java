package com.nttdata.bc19.mstransactioncreditcard.webclient.impl;

import com.nttdata.bc19.mstransactioncreditcard.exception.ModelNotFoundException;
import com.nttdata.bc19.mstransactioncreditcard.model.responseWC.*;
import com.nttdata.bc19.mstransactioncreditcard.webclient.IServiceWC;
...
public class ServiceWCImpl implements IServiceWC {
    ...
    public Mono<FixedTermAccountPerson> updateFixedTermAccountPerson(FixedTermAccountPerson fixedTermAccountPerson) {
        return webClient.baseUrl(URL_GATEWAY).build().put().uri("/api/fixed-term-account/person/")
    ...
    public Mono<SavingAccountPerson> updateSavingAccountPerson(SavingAccountPerson savingAccountPerson) {
        return webClient.baseUrl(URL_GATEWAY).build().put().uri("/api/saving-account/person/")
    ...
    public Mono<CreditBusiness> updateCreditBusiness(CreditBusiness creditBusiness) {
        return webClient.baseUrl(URL_GATEWAY).build().put().uri("/api/active/credit/business/")
    ...
    public Mono<CreditCardPerson> updateCreditCardPerson(CreditCardPerson creditCardPerson) {
        return webClient.baseUrl(URL_GATEWAY).build().put().uri("/api/active/credit-card/person/")
    ...
    public Mono<CreditCardBusiness> updateCreditCardBusiness(CreditCardBusiness creditCardBusiness) {
        return webClient.baseUrl(URL_GATEWAY).build().put().uri("/api/active/credit-card/business/")
